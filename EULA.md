...
This End User License Agreement ("Agreement") is a legal agreement between you ("you" or "the user") and the developer of Highlight Inbox Synthesizer ("the Software"). By installing, activating, or using the Software, you agree to the terms of this Agreement. If you do not agree, do not use the Software.
...
The Software runs on your device. It has no server, no database, and no telemetry. Your API key is stored locally on your device. When you sync, the Software transmits the text of your highlights to the language model provider you configure, using your own key, for the purpose of generating synthesis output. That content is handled by your chosen provider under its terms. The developer does not receive, store, or have access to your highlights, your API key, or any usage data.
